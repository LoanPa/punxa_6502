...
;	Raw cost for generated ic 281 : (10, 14.000000) count=1.000000
;	genLabel
00101$:
...
;	genIfxJump : z
	...
	jmp	00128$
00335$:
;	Raw cost for generated ic 49 : (7, 7.600000) count=0.999993
...
;	genAssignLit
	ldx	#0x02
	stx	_wcsncmp_PARM_3
	stz	(_wcsncmp_PARM_3 + 1)
;	Raw cost for generated ic 56 : (8, 10.000000) count=0.749995
...
;	genAssignLit
	...
	stx	_wcsncmp_PARM_3
	stz	(_wcsncmp_PARM_3 + 1)
;	Raw cost for generated ic 65 : (8, 10.000000) count=0.562496
...
;	genCopy
	ldx	#0x10
;	Raw cost for generated ic 70 : (2, 2.000000) count=0.609371
;	../wcstoul.c: 89: ptr += 2;
;	genPlus
;	  genPlusInc
	lda	_wcstoul_ptr_10000_164
...
;	genAssignLit
	...
	stx	_wcsncmp_PARM_3
	stz	(_wcsncmp_PARM_3 + 1)
;	Raw cost for generated ic 79 : (8, 10.000000) count=0.140623
...
;	genAssignLit
	...
	stx	_wcsncmp_PARM_3
	stz	(_wcsncmp_PARM_3 + 1)
;	Raw cost for generated ic 88 : (8, 10.000000) count=0.105467
...
;	genCopy
	ldx	#0x02
;	Raw cost for generated ic 93 : (2, 2.000000) count=0.114256
;	../wcstoul.c: 94: ptr += 2;
;	genPlus
;	  genPlusInc
	lda	_wcstoul_ptr_10000_164
...
;	genCopy
	ldx	#0x08
;	Raw cost for generated ic 104 : (2, 2.000000) count=0.015727
;	../wcstoul.c: 99: ptr++;
;	genPlus
;	  genPlusInc
	lda	_wcstoul_ptr_10000_164
...
;	genCopy
	ldx	#0x0a
;	Raw cost for generated ic 110 : (2, 2.000000) count=0.000000
;	genGoto
	jmp	00129$
...
;	genCmpEQorNE
	cpx	#0x10
	bne	00123$
;	Raw cost for generated ic 116 : (7, 7.600000) count=0.249997
;	skipping generated iCode
...
;	genAssignLit
	...
	sty	_wcsncmp_PARM_3
	stz	(_wcsncmp_PARM_3 + 1)
;	Raw cost for generated ic 124 : (8, 10.000000) count=0.187496
...
;	assignResultValue
	sta	*_wcstoul_sloc2_1_0
	stx	*(_wcstoul_sloc2_1_0 + 1)
	plx
;	Raw cost for generated ic 125 : (15, 27.000000) count=0.187496
;	genIfx
	lda	*(_wcstoul_sloc2_1_0 + 1)
	ora	*_wcstoul_sloc2_1_0
;	genIfxJump : z
	beq	00122$
;	Raw cost for generated ic 126 : (9, 11.600000) count=0.187496
;	skipping iCode since result will be rematerialized
...
;	genAssignLit
	...
	sty	_wcsncmp_PARM_3
	stz	(_wcsncmp_PARM_3 + 1)
;	Raw cost for generated ic 133 : (8, 10.000000) count=0.140622
...
;	assignResultValue
	...
	stx	*(_wcstoul_sloc2_1_0 + 1)
	plx
;	Raw cost for generated ic 134 : (15, 27.000000) count=0.140622
;	genIfx
	lda	*(_wcstoul_sloc2_1_0 + 1)
	ora	*_wcstoul_sloc2_1_0
;	genIfxJump : z
	bne	00123$
;	Raw cost for generated ic 135 : (9, 11.600000) count=0.140622
;	genLabel
00122$:
...
;	genCmpEQorNE
	cpx	#0x02
	bne	00129$
;	Raw cost for generated ic 142 : (7, 7.600000) count=0.097654
;	skipping generated iCode
...
;	genAssignLit
	...
	sty	_wcsncmp_PARM_3
	stz	(_wcsncmp_PARM_3 + 1)
;	Raw cost for generated ic 150 : (8, 10.000000) count=0.073241
...
;	assignResultValue
	...
	stx	*(_wcstoul_sloc2_1_0 + 1)
	plx
;	Raw cost for generated ic 151 : (15, 27.000000) count=0.073241
;	genIfx
	lda	*(_wcstoul_sloc2_1_0 + 1)
	ora	*_wcstoul_sloc2_1_0
;	genIfxJump : z
	beq	00118$
;	Raw cost for generated ic 152 : (9, 11.600000) count=0.073241
;	skipping iCode since result will be rematerialized
...
;	genAssignLit
	...
	sty	_wcsncmp_PARM_3
	stz	(_wcsncmp_PARM_3 + 1)
;	Raw cost for generated ic 159 : (8, 10.000000) count=0.054931
...
;	assignResultValue
	...
	stx	*(_wcstoul_sloc2_1_0 + 1)
	plx
;	Raw cost for generated ic 160 : (15, 27.000000) count=0.054931
;	genIfx
	lda	*(_wcstoul_sloc2_1_0 + 1)
	ora	*_wcstoul_sloc2_1_0
;	genIfxJump : z
	bne	00129$
;	Raw cost for generated ic 161 : (9, 11.600000) count=0.054931
;	genLabel
00118$:
...
;	genAssign
;	genCopy
	stx	__isdigit_PARM_2
;	Raw cost for generated ic 172 : (3, 4.000000) count=0.989349
;	genCall
	phx
	jsr	__isdigit
;	assignResultValue
	sta	*_wcstoul_sloc2_1_0
	plx
;	Raw cost for generated ic 173 : (7, 16.000000) count=0.989349
;	genCmp
...
;	genAssign
;	genAssignLit
	stz	_wcstoul_ret_10000_164
	stz	(_wcstoul_ret_10000_164 + 1)
	stz	(_wcstoul_ret_10000_164 + 2)
	stz	(_wcstoul_ret_10000_164 + 3)
;	Raw cost for generated ic 186 : (12, 16.000000) count=0.989349
;	genAssign
;	genCopy
	lda	(_wcstoul_ptr_10000_164 + 1)
	sta	*(_wcstoul_sloc2_1_0 + 1)
...
;	genCopy
	stx	__isdigit_PARM_2
;	Raw cost for generated ic 191 : (3, 4.000000) count=3.958003
;	genCall
	phx
	jsr	__isdigit
;	assignResultValue
	...
	plx
;	Raw cost for generated ic 192 : (8, 17.000000) count=3.958003
...
;	genCopy
	...
	stx	__mullonglong_PARM_2
;	Raw cost for generated ic 200 : (24, 32.000000) count=2.968654
;	genCast
;	genCopy
...
;	assignResultValue
	...
	plx
;	Raw cost for generated ic 295 : (33, 55.000000) count=2.968654
;	genAssign
;	genCopy
...
;	Raw cost for generated ic 211 : (40, 56.000000) count=2.968654
;	genCast
;	genCopy
;	Raw cost for generated ic 213 : (16, 24.000000) count=2.968654
;	genPointerSet
;	genDataPointerSet
	lda	*(_wcstoul_sloc3_1_0 + 3)
...
;	genCast
;	genCopy
	stz	*(_wcstoul_sloc3_1_0 + 7)
	stz	*(_wcstoul_sloc3_1_0 + 6)
	stz	*(_wcstoul_sloc3_1_0 + 5)
	stz	*(_wcstoul_sloc3_1_0 + 4)
	lda	*_wcstoul_sloc3_1_0
;	Raw cost for generated ic 217 : (28, 40.000000) count=2.968654
;	genCmpEQorNE
...
00377$:
	lda	#0x01
00376$:
;	Raw cost for generated ic 218 : (81, 101.399994) count=2.968654
;	genNot
	eor	#0x01
...
;	genCast
	...
	sta	*(_wcstoul_sloc3_1_0 + 6)
	sta	*(_wcstoul_sloc3_1_0 + 7)
;	Raw cost for generated ic 225 : (26, 36.000000) count=2.968654
;	genCast
;	genCopy
	stz	*(_wcstoul_sloc4_1_0 + 7)
	stz	*(_wcstoul_sloc4_1_0 + 6)
	stz	*(_wcstoul_sloc4_1_0 + 5)
	stz	*(_wcstoul_sloc4_1_0 + 4)
	lda	(_wcstoul_ret_10000_164 + 3)
	...
	lda	_wcstoul_ret_10000_164
;	Raw cost for generated ic 227 : (32, 44.000000) count=2.968654
;	skipping iCode since result will be rematerialized
...
;	genCopy
	...
	stz	*(_wcstoul_sloc4_1_0 + 4)
	lda	*_wcstoul_sloc4_1_0
;	Raw cost for generated ic 242 : (28, 40.000000) count=2.968654
;	genCmpEQorNE
...
00388$:
	lda	#0x01
00387$:
;	Raw cost for generated ic 243 : (81, 101.399994) count=2.968654
;	genNot
	eor	#0x01
...
;	genAssignLit
	...
	stx	_errno
	stz	(_errno + 1)
;	Raw cost for generated ic 266 : (8, 10.000000) count=0.742214
