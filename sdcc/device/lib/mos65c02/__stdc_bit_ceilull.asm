...
;	Raw cost for generated ic 31 : (26, 34.000000) count=2.285713
;	genCall
	phx
	jsr	__slulonglong
;	assignResultValue
	...
	plx
;	Raw cost for generated ic 33 : (33, 55.000000) count=2.285713
;	genCmp
...
;	genAssignLit
	...
	stz	(__slulonglong_PARM_1 + 6)
	stz	(__slulonglong_PARM_1 + 7)
;	Raw cost for generated ic 35 : (26, 34.000000) count=0.999999
;	genCall
	jsr	__slulonglong
;	assignResultValue
	sta	*___stdc_bit_ceilull_sloc0_1_0
