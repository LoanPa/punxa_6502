...
;	genCast
;	genCopy
	stz	*(___ckd_sub_ushort_sloc1_1_0 + 7)
	stz	*(___ckd_sub_ushort_sloc1_1_0 + 6)
	stz	*(___ckd_sub_ushort_sloc1_1_0 + 5)
	stz	*(___ckd_sub_ushort_sloc1_1_0 + 4)
	stz	*(___ckd_sub_ushort_sloc1_1_0 + 3)
	stz	*(___ckd_sub_ushort_sloc1_1_0 + 2)
...
;	genCast
;	genCopy
	stz	*(___ckd_sub_uint_sloc1_1_0 + 7)
	stz	*(___ckd_sub_uint_sloc1_1_0 + 6)
	stz	*(___ckd_sub_uint_sloc1_1_0 + 5)
	stz	*(___ckd_sub_uint_sloc1_1_0 + 4)
	stz	*(___ckd_sub_uint_sloc1_1_0 + 3)
	stz	*(___ckd_sub_uint_sloc1_1_0 + 2)
...
;	genCast
;	genCopy
	stz	*(___ckd_sub_ulong_sloc2_1_0 + 7)
	stz	*(___ckd_sub_ulong_sloc2_1_0 + 6)
	stz	*(___ckd_sub_ulong_sloc2_1_0 + 5)
	stz	*(___ckd_sub_ulong_sloc2_1_0 + 4)
