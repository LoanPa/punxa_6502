...
;	genAssign
;	genAssignLit
	stz	_atof_sign_10000_63
;	Raw cost for generated ic 29 : (3, 4.000000) count=0.249999
;	../_atof.c: 51: if (*s == '+') s++;
;	genCmpEQorNE
	cpy	#0x2b
	bne	00108$
...
;	genAssign
;	genAssignLit
	stz	_atof_value_10000_63
	stz	(_atof_value_10000_63 + 1)
	stz	(_atof_value_10000_63 + 2)
	stz	(_atof_value_10000_63 + 3)
;	Raw cost for generated ic 41 : (12, 16.000000) count=0.999997
;	genAssign
;	genCopy
	sta	*_atof_sloc0_1_0
	stx	*(_atof_sloc0_1_0 + 1)
...
;	genAssignLit
	...
	ldx	#0x41
	stx	(___fsmul_PARM_1 + 3)
;	Raw cost for generated ic 233 : (16, 20.000000) count=0.562428
;	genAssign
;	genCopy
	lda	(_atof_value_10000_63 + 3)
	sta	(___fsmul_PARM_2 + 3)
