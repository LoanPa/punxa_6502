...
;	  genrsh32 - shift=12
	...
	stz	*(_wctomb_sloc1_1_0 + 3)
;	Raw cost for generated ic 54 : (36, 67.000000) count=0.750000
;	genCast
;	genCopy
...
;	  setupDPTR - off=0 remat=(null) savea=0
	...
	ldy	#0x00
	sta	[DPTR],y
;	Raw cost for generated ic 58 : (14, 22.000000) count=0.750000
...
;	  setupDPTR - off=0 remat=(null) savea=0
	...
	ldy	#0x00
	sta	[DPTR],y
;	Raw cost for generated ic 84 : (14, 22.000000) count=0.750000
