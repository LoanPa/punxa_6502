...
;	genAssign
;	genAssignLit
	stz	___mbstoc16s_m_10000_65
	stz	(___mbstoc16s_m_10000_65 + 1)
...
;	Raw cost for generated ic 9 : (8, 10.000000) count=1.230679
...
;	  genrsh32 - shift=10
	...
	sta	*(___mbstoc16s_sloc1_1_0 + 2)
	stz	*(___mbstoc16s_sloc1_1_0 + 3)
;	Raw cost for generated ic 64 : (27, 45.000000) count=0.057634
;	genCast
;	genCopy
...
;	genPointerSet
	...
	iny
	sta	[*___mbstoc16s_sloc0_1_0],y
;	Raw cost for generated ic 68 : (8, 18.000000) count=0.057634
;	genPlus
;	  genPlusInc
	lda	*___mbstoc16s_sloc0_1_0
	clc
