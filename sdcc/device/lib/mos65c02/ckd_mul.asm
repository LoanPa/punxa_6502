...
00112$:
	lda	#0x01
00111$:
;	Raw cost for generated ic 11 : (74, 96.399994) count=1.000000
;	genNot
	eor	#0x01
...
00112$:
	lda	#0x01
00111$:
;	Raw cost for generated ic 11 : (72, 93.399994) count=1.000000
;	genNot
	eor	#0x01
;	Raw cost for generated ic 12 : (2, 2.000000) count=1.000000
;	genRet
...
00113$:
	tya
00112$:
;	Raw cost for generated ic 11 : (70, 90.399994) count=1.000000
;	genNot
	eor	#0x01
;	Raw cost for generated ic 12 : (2, 2.000000) count=1.000000
;	genRet
...
;	genCast
;	genCopy
	stz	*(___ckd_mul_ushort_sloc1_1_0 + 7)
	stz	*(___ckd_mul_ushort_sloc1_1_0 + 6)
	stz	*(___ckd_mul_ushort_sloc1_1_0 + 5)
	stz	*(___ckd_mul_ushort_sloc1_1_0 + 4)
	stz	*(___ckd_mul_ushort_sloc1_1_0 + 3)
	stz	*(___ckd_mul_ushort_sloc1_1_0 + 2)
	stx	*(___ckd_mul_ushort_sloc1_1_0 + 1)
	sta	*___ckd_mul_ushort_sloc1_1_0
;	Raw cost for generated ic 10 : (22, 30.000000) count=1.000000
;	genCmpEQorNE
...
;	genCast
;	genCopy
	stz	*(___ckd_mul_uint_sloc1_1_0 + 7)
	stz	*(___ckd_mul_uint_sloc1_1_0 + 6)
	stz	*(___ckd_mul_uint_sloc1_1_0 + 5)
	stz	*(___ckd_mul_uint_sloc1_1_0 + 4)
	stz	*(___ckd_mul_uint_sloc1_1_0 + 3)
	stz	*(___ckd_mul_uint_sloc1_1_0 + 2)
...
00112$:
	lda	#0x01
00111$:
;	Raw cost for generated ic 11 : (75, 96.399994) count=1.000000
;	genNot
	eor	#0x01
;	Raw cost for generated ic 12 : (2, 2.000000) count=1.000000
;	genRet
...
;	genCast
;	genCopy
	stz	*(___ckd_mul_ulong_sloc2_1_0 + 7)
	stz	*(___ckd_mul_ulong_sloc2_1_0 + 6)
	stz	*(___ckd_mul_ulong_sloc2_1_0 + 5)
	stz	*(___ckd_mul_ulong_sloc2_1_0 + 4)
...
;	Raw cost for generated ic 10 : (26, 37.000000) count=1.000000
;	genCmpEQorNE
...
00112$:
	lda	#0x01
00111$:
;	Raw cost for generated ic 11 : (73, 93.399994) count=1.000000
;	genNot
	eor	#0x01
;	Raw cost for generated ic 12 : (2, 2.000000) count=1.000000
;	genRet
