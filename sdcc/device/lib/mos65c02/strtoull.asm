...
;	genAssign
;	genAssignLit
	stz	_strtoull_ret_10000_95
	stz	(_strtoull_ret_10000_95 + 1)
	stz	(_strtoull_ret_10000_95 + 2)
	stz	(_strtoull_ret_10000_95 + 3)
	stz	(_strtoull_ret_10000_95 + 4)
	stz	(_strtoull_ret_10000_95 + 5)
	stz	(_strtoull_ret_10000_95 + 6)
	stz	(_strtoull_ret_10000_95 + 7)
;	Raw cost for generated ic 189 : (24, 32.000000) count=0.989349
;	genAssign
;	genCopy
...
;	Raw cost for generated ic 204 : (27, 36.000000) count=2.968624
;	genAssign
;	genCopy
	lda	(_strtoull_ret_10000_95 + 7)
...
;	genCast
	...
	stz	*(_strtoull_sloc1_1_0 + 1)
	stz	*(_strtoull_sloc1_1_0 + 2)
	stz	*(_strtoull_sloc1_1_0 + 3)
	stz	*(_strtoull_sloc1_1_0 + 4)
	stz	*(_strtoull_sloc1_1_0 + 5)
	stz	*(_strtoull_sloc1_1_0 + 6)
	stz	*(_strtoull_sloc1_1_0 + 7)
;	Raw cost for generated ic 215 : (23, 31.000000) count=2.968816
;	genPlus
	lda	_strtoull_ret_10000_95
	clc
...
;	genAssignLit
	...
	stx	_errno
	stz	(_errno + 1)
;	Raw cost for generated ic 234 : (8, 10.000000) count=0.742204
