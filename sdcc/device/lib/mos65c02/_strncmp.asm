...
;	genCopy
	ldx	#0x00
;	Raw cost for generated ic 37 : (2, 2.000000) count=0.999998
;	genPointerGet
	sta	*(REGTEMP+0)
	lda	[*_strncmp_sloc1_1_0],y
	tay
	lda	*(REGTEMP+0)
;	Raw cost for generated ic 39 : (7, 13.000000) count=0.999998
;	genCast
;	genCopy
	stx	*(_strncmp_sloc2_1_0 + 1)
	sty	*_strncmp_sloc2_1_0
;	Raw cost for generated ic 40 : (4, 6.000000) count=0.999998
;	genMinus
	sec
	sbc	*_strncmp_sloc2_1_0
	pha
	txa
	sbc	*(_strncmp_sloc2_1_0 + 1)
	tax
	pla
;	Raw cost for generated ic 41 : (9, 19.000000) count=0.999998
;	genRet
