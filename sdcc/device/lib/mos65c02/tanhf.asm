...
;	genAssign
;	genAssignLit
	stz	_tanhf_r_10000_26
	stz	(_tanhf_r_10000_26 + 1)
	ldx	#0x80
	stx	(_tanhf_r_10000_26 + 2)
	ldx	#0x3f
	stx	(_tanhf_r_10000_26 + 3)
;	Raw cost for generated ic 9 : (16, 20.000000) count=0.750000
;	genGoto
	jmp	00109$
...
;	Raw cost for generated ic 68 : (16, 20.000000) count=0.187500
;	genCall
	jsr	___fsadd
;	assignResultValue
	sta	___fsdiv_PARM_2
...
;	Raw cost for generated ic 70 : (16, 20.000000) count=0.187500
;	genCall
	jsr	___fsdiv
;	assignResultValue
	sta	___fssub_PARM_2
...
;	genAssignLit
	...
	stz	(___fssub_PARM_1 + 2)
	ldx	#0x3f
	stx	(___fssub_PARM_1 + 3)
;	Raw cost for generated ic 73 : (14, 18.000000) count=0.187500
;	../tanhf.c: 59: r+=r;
;	genCall
	jsr	___fssub
;	assignResultValue
...
;	Raw cost for generated ic 80 : (16, 20.000000) count=0.062500
;	genCall
	jsr	___fslt
;	assignResultValue
...
;	Raw cost for generated ic 107 : (12, 16.000000) count=1.000000
;	genCall
	jsr	___fslt
;	assignResultValue
