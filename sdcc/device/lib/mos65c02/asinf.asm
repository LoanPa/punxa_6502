...
;------------------------------------------------------------
;sloc0         Allocated with name '_asinf_sloc0_1_0'
;x             Allocated with name '_asinf_PARM_1'
;------------------------------------------------------------
...
;	Raw cost for generated ic 32 : (16, 20.000000) count=1.000000
;	genCall
	jsr	___fseq
;	assignResultValue
...
;	genRet
	...
	rts
;	Raw cost for generated ic 6 : (15, 17.000000) count=0.750000
;	genLabel
00108$:
...
;	genAssignLit
	...
	ldx	#0xbf
	stx	(___fseq_PARM_2 + 3)
;	Raw cost for generated ic 35 : (16, 20.000000) count=1.000000
;	genCall
	jsr	___fseq
;	assignResultValue
...
;	genRet
	...
	rts
;	Raw cost for generated ic 19 : (10, 13.000000) count=0.750000
;	genLabel
00102$:
...
;	genAssign
;	genAssignLit
	stz	_asincosf_PARM_2
;	Raw cost for generated ic 23 : (3, 4.000000) count=1.000000
;	genCall
	jsr	_asincosf
;	assignResultValue
	sta	*_asinf_sloc0_1_0
	stx	*(_asinf_sloc0_1_0 + 1)
	lda	*___SDCC_m6502_ret2
	sta	*(_asinf_sloc0_1_0 + 2)
	lda	*___SDCC_m6502_ret3
	sta	*(_asinf_sloc0_1_0 + 3)
;	Raw cost for generated ic 24 : (15, 24.000000) count=1.000000
;	genRet
	sta	*___SDCC_m6502_ret3
	lda	*(_asinf_sloc0_1_0 + 2)
	sta	*___SDCC_m6502_ret2
	lda	*_asinf_sloc0_1_0
