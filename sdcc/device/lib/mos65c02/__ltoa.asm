...
;	genCast
;	genCopy
	stz	*(___ultoa_sloc1_1_0 + 3)
	stz	*(___ultoa_sloc1_1_0 + 2)
	stz	*(___ultoa_sloc1_1_0 + 1)
	lda	___ultoa_PARM_3
	sta	*___ultoa_sloc1_1_0
;	Raw cost for generated ic 4 : (14, 19.000000) count=3.999997
;	genAssign
;	genCopy
...
;	Raw cost for generated ic 57 : (2, 3.000000) count=0.999998
;	genLabel
00106$:
...
;	genCopy
	stz	*(___ultoa_sloc1_1_0 + 1)
	stx	*___ultoa_sloc1_1_0
;	Raw cost for generated ic 35 : (5, 7.000000) count=3.999988
;	genPointerGet
;	  setupDPTR - off=0 remat=___ultoa_buffer_10000_43 savea=0
	clc
	txa
	adc	#<(___ultoa_buffer_10000_43+0)
	sta	*(DPTR+0)
	lda	*(___ultoa_sloc1_1_0 + 1)
	adc	#>(___ultoa_buffer_10000_43+0)
	sta	*(DPTR+1)
	ldy	#0x00
	lda	[DPTR],y
;	Raw cost for generated ic 36 : (16, 24.000000) count=3.999988
;	genPointerSet
	sta	[*___ultoa_sloc2_1_0],y
;	Raw cost for generated ic 37 : (2, 6.000000) count=3.999988
;	genPlus
;	  genPlusInc
...
;	  genPlusInc
	inx
;	Raw cost for generated ic 39 : (1, 2.000000) count=3.999988
;	genCmpEQorNE
	cpx	#0x20
	bne	00106$
