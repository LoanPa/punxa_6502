...
;	Raw cost for generated ic 98 : (12, 16.000000) count=0.250000
;	genCall
	jsr	___fslt
;	assignResultValue
...
;	genAssignLit
	stz	_sincosf_sign_10000_26
;	Raw cost for generated ic 22 : (3, 4.000000) count=0.062500
;	genLabel
00106$:
...
;	Raw cost for generated ic 100 : (18, 22.000000) count=1.000000
;	genAssign
;	genCopy
...
;	genAssignLit
	...
	stx	_errno
	stz	(_errno + 1)
;	Raw cost for generated ic 30 : (8, 10.000000) count=0.750000
...
;	genRet
	...
	rts
;	Raw cost for generated ic 31 : (10, 13.000000) count=0.750000
;	genLabel
00108$:
...
;	Raw cost for generated ic 114 : (14, 18.000000) count=0.750000
;	genCall
	jsr	___fssub
;	assignResultValue
	sta	_sincosf_XN_10000_26
...
;	genAssignLit
	...
	ldx	#0x40
	stx	(___fsmul_PARM_1 + 3)
;	Raw cost for generated ic 123 : (16, 20.000000) count=1.000000
;	genAssign
;	genCopy
