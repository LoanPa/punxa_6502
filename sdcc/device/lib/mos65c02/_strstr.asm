...
;	genPointerGet
	...
	tay
;	Raw cost for generated ic 26 : (3, 7.000000) count=3.891822
;	genIfx
;	genIfxJump : z
	beq	00107$
...
;	genCast
;	genCopy
	stx	*(_strstr_sloc4_1_0 + 1)
	sty	*_strstr_sloc4_1_0
;	Raw cost for generated ic 35 : (4, 6.000000) count=2.918866
;	genMinus
	sec
	sbc	*_strstr_sloc4_1_0
	pha
	txa
	sbc	*(_strstr_sloc4_1_0 + 1)
	tax
	pla
;	Raw cost for generated ic 36 : (9, 19.000000) count=2.918866
;	genIfx
;	genIfxJump : z
	bne	00107$
	cpx	#0x00
