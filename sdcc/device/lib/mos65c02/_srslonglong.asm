...
;	genAssign
;	genAssignLit
	stz	*__srslonglong_sloc0_1_0
;	Raw cost for generated ic 122 : (3, 4.000000) count=0.750000
;	genLabel
00110$:
...
;	genAssign
;	genCopy
	stz	*(__srslonglong_sloc3_1_0 + 1)
	sta	*__srslonglong_sloc3_1_0
;	Raw cost for generated ic 82 : (5, 7.000000) count=0.999888
;	genPointerGet
;	  setupDPTR - off=0 remat=__srslonglong_PARM_1 savea=0
	clc
	adc	#<(__srslonglong_PARM_1+0)
	...
	ldy	#0x00
	lda	[DPTR],y
;	Raw cost for generated ic 83 : (16, 24.000000) count=0.999888
;	genAnd
	tay
	and	#0x01
