...
;	genAssign
;	genAssignLit
	stz	_atoll_ret_10000_63
	stz	(_atoll_ret_10000_63 + 1)
	stz	(_atoll_ret_10000_63 + 2)
	stz	(_atoll_ret_10000_63 + 3)
	stz	(_atoll_ret_10000_63 + 4)
	stz	(_atoll_ret_10000_63 + 5)
	stz	(_atoll_ret_10000_63 + 6)
	stz	(_atoll_ret_10000_63 + 7)
