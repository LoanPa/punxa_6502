...
;	genAnd
	stz	*(_ldexpf_sloc0_1_0 + 1)
	stz	*(_ldexpf_sloc0_1_0 + 2)
	stz	*(_ldexpf_sloc0_1_0 + 3)
...
;	Raw cost for generated ic 11 : (21, 28.000000) count=1.000000
;	genPlus
...
;	genAnd
	stz	*(_ldexpf_sloc1_1_0 + 1)
	stz	*(_ldexpf_sloc1_1_0 + 2)
	stz	*(_ldexpf_sloc1_1_0 + 3)
;	Raw cost for generated ic 16 : (9, 12.000000) count=1.000000
;	genLeftShift
;	genLeftShiftLiteral
;	  genlsh32 - shift=23
	...
	ror	a
	sta	*(_ldexpf_sloc1_1_0 + 2)
;	Raw cost for generated ic 17 : (17, 26.000000) count=1.000000
;	genPointerGet
;	genDataPointerGet
	lda	(_ldexpf_fl_10000_26 + 3)
	sta	*(_ldexpf_sloc0_1_0 + 3)
