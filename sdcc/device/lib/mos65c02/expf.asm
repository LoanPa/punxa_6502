...
;	genAssign
;	genAssignLit
	stz	_expf_sign_10000_26
;	Raw cost for generated ic 7 : (3, 4.000000) count=0.750000
;	genGoto
	jmp	00103$
...
;	genAssignLit
	...
	stx	_errno
	stz	(_errno + 1)
;	Raw cost for generated ic 28 : (8, 10.000000) count=0.562500
;	../expf.c: 350: ;
;	genRet
	lda	#0xff
	tax
...
;	genAssignLit
	...
	ldx	#0x3f
	stx	(___fslt_PARM_2 + 3)
;	Raw cost for generated ic 112 : (14, 18.000000) count=1.000000
;	genCall
	jsr	___fslt
;	assignResultValue
...
;	genAssignLit
	...
	ldx	#0x3f
	stx	(___fsmul_PARM_1 + 3)
;	Raw cost for generated ic 116 : (18, 22.000000) count=1.000000
;	genAssign
;	genCopy
	sta	(___fsmul_PARM_2 + 3)
	lda	*(_expf_sloc0_1_0 + 2)
...
;	Raw cost for generated ic 135 : (16, 20.000000) count=1.000000
;	genCall
	jsr	___fsadd
;	assignResultValue
	sta	___fsmul_PARM_1
...
;	genAssignLit
	...
	ldx	#0x3f
	stx	(___fsadd_PARM_2 + 3)
;	Raw cost for generated ic 144 : (14, 18.000000) count=1.000000
;	genCall
	jsr	___fsadd
;	assignResultValue
	sta	___fssub_PARM_1
...
;	genAssignLit
	...
	ldx	#0x3f
	stx	(___fsadd_PARM_2 + 3)
;	Raw cost for generated ic 153 : (14, 18.000000) count=1.000000
;	genCall
	jsr	___fsadd
;	assignResultValue
...
;	Raw cost for generated ic 155 : (16, 20.000000) count=0.750000
;	genAssign
;	genCopy
	lda	*(_expf_sloc2_1_0 + 3)
	sta	(___fsdiv_PARM_2 + 3)
