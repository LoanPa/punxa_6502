...
;	genAssign
;	genAssignLit
	stz	__divulonglong_reste_10000_2
	stz	(__divulonglong_reste_10000_2 + 1)
	stz	(__divulonglong_reste_10000_2 + 2)
	stz	(__divulonglong_reste_10000_2 + 3)
	stz	(__divulonglong_reste_10000_2 + 4)
	stz	(__divulonglong_reste_10000_2 + 5)
	stz	(__divulonglong_reste_10000_2 + 6)
	stz	(__divulonglong_reste_10000_2 + 7)
