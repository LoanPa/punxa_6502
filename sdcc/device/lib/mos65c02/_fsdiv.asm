...
;	genAnd
;	Raw cost for generated ic 10 : (5, 7.000000) count=1.000000
;	../_fsdiv.c: 287: if (!exp)
;	genIfx
	stz	*(___fsdiv_org_sloc0_1_0 + 1)
...
;	genAnd
	stz	*(___fsdiv_org_sloc2_1_0 + 3)
;	Raw cost for generated ic 51 : (3, 4.000000) count=1.000000
;	genOr
...
;	genCmp
	...
	bcs	00104$
;	Raw cost for generated ic 60 : (28, 37.599998) count=1.000000
;	skipping generated iCode
;	Raw cost for generated ic 61 : (0, 0.000000) count=1.000000
;	../_fsdiv.c: 305: mask = 0x1000000;
;	genAssign
;	genAssignLit
	stz	___fsdiv_org_mask_10000_21
	stz	(___fsdiv_org_mask_10000_21 + 1)
	stz	(___fsdiv_org_mask_10000_21 + 2)
	ldy	#0x01
	sty	(___fsdiv_org_mask_10000_21 + 3)
;	Raw cost for generated ic 64 : (14, 18.000000) count=0.750000
;	genGoto
	jmp	00105$
...
;	genAssignLit
	stz	___fsdiv_org_mask_10000_21
	stz	(___fsdiv_org_mask_10000_21 + 1)
	stz	(___fsdiv_org_mask_10000_21 + 3)
	ldy	#0x80
	sty	(___fsdiv_org_mask_10000_21 + 2)
;	Raw cost for generated ic 67 : (14, 18.000000) count=0.250000
;	../_fsdiv.c: 310: exp++;
;	genPlus
;	  genPlusInc
...
;	genAssign
;	genAssignLit
	stz	___fsdiv_org_result_10000_21
	stz	(___fsdiv_org_result_10000_21 + 1)
	stz	(___fsdiv_org_result_10000_21 + 2)
	stz	(___fsdiv_org_result_10000_21 + 3)
;	Raw cost for generated ic 93 : (12, 16.000000) count=0.250000
;	../_fsdiv.c: 324: do
;	genLabel
00110$:
...
;	genAssign
;	genAssignLit
	stz	*___fsdiv_org_sloc2_1_0
	stz	*(___fsdiv_org_sloc2_1_0 + 1)
	stz	*(___fsdiv_org_sloc2_1_0 + 2)
	ldx	#0x80
	stx	*(___fsdiv_org_sloc2_1_0 + 3)
;	Raw cost for generated ic 125 : (13, 17.000000) count=0.187475
;	genGoto
	jmp	00123$
...
;	genAssignLit
	...
	stz	*(___fsdiv_org_sloc2_1_0 + 2)
	stz	*(___fsdiv_org_sloc2_1_0 + 3)
;	Raw cost for generated ic 128 : (12, 16.000000) count=0.062492
;	genLabel
00123$:
...
;	Raw cost for generated ic 45 : (12, 16.000000) count=0.750000
;	genAssign
;	genCopy
...
;	genDataPointerSet
	...
	stz	(___fsdiv_f_30000_37 + 1)
	stz	___fsdiv_f_30000_37
;	Raw cost for generated ic 22 : (15, 20.000000) count=0.562500
;	genGoto
	jmp	00106$
...
;	Raw cost for generated ic 49 : (12, 16.000000) count=0.187500
;	genCall
	jsr	___fslt
;	assignResultValue
...
;	genDataPointerSet
	...
	stz	(___fsdiv_f_30000_37 + 1)
	stz	___fsdiv_f_30000_37
;	Raw cost for generated ic 30 : (16, 20.000000) count=0.140625
;	genGoto
	jmp	00106$
...
;	genDataPointerSet
	...
	stz	(___fsdiv_f_30000_37 + 1)
	stz	___fsdiv_f_30000_37
;	Raw cost for generated ic 34 : (16, 20.000000) count=0.046875
;	genLabel
00106$:
