...
;	  genrsh32 - shift=10
	...
	ror	*_rand_sloc0_1_0
	sta	*(_rand_sloc0_1_0 + 2)
	stz	*(_rand_sloc0_1_0 + 3)
;	Raw cost for generated ic 3 : (30, 49.000000) count=1.000000
;	genXor
	lda	_s
	eor	*_rand_sloc0_1_0
	sta	*_rand_sloc0_1_0
...
;	Raw cost for generated ic 6 : (18, 28.000000) count=1.000000
;	genXor
	lda	*_rand_sloc0_1_0
	eor	*_rand_sloc1_1_0
	sta	*_rand_sloc1_1_0
...
;	  genrsh32 - shift=25
	lsr	a
	sta	*_rand_sloc0_1_0
	stz	*(_rand_sloc0_1_0 + 1)
	stz	*(_rand_sloc0_1_0 + 2)
	stz	*(_rand_sloc0_1_0 + 3)
;	Raw cost for generated ic 9 : (12, 17.000000) count=1.000000
;	genXor
	lda	*_rand_sloc1_1_0
	eor	*_rand_sloc0_1_0
	sta	*_rand_sloc1_1_0
...
;	genCast
;	genCopy
	stz	*(_srand_sloc0_1_0 + 3)
	stz	*(_srand_sloc0_1_0 + 2)
