...
;denominatorneg Allocated to registers y 
...
00130$:
	tay
;	Raw cost for generated ic 4 : (12, 15.200001) count=1.000000
...
;	assignResultValue
	...
	plx
;	Raw cost for generated ic 34 : (33, 55.000000) count=1.000000
;	genIfx
;	genIfxJump : z
	beq	00107$
;	Raw cost for generated ic 22 : (5, 5.600000) count=1.000000
;	genUminus
	lda	#0x00
	sec
