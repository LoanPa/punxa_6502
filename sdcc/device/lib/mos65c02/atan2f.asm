...
;	genAssignLit
	...
	stx	_errno
	stz	(_errno + 1)
;	Raw cost for generated ic 9 : (8, 10.000000) count=0.562500
...
;	genRet
	...
	rts
;	Raw cost for generated ic 10 : (10, 13.000000) count=0.562500
;	genLabel
00102$:
...
;	Raw cost for generated ic 66 : (12, 16.000000) count=0.750000
;	genCall
	jsr	___fslt
;	assignResultValue
...
;	genAssignLit
	...
	stz	(___fslt_PARM_2 + 2)
	stz	(___fslt_PARM_2 + 3)
;	Raw cost for generated ic 69 : (12, 16.000000) count=0.562500
;	genCall
	jsr	___fslt
;	assignResultValue
...
;	genAssignLit
	...
	stz	(___fslt_PARM_2 + 2)
	stz	(___fslt_PARM_2 + 3)
;	Raw cost for generated ic 78 : (12, 16.000000) count=0.250000
;	genCall
	jsr	___fslt
;	assignResultValue
