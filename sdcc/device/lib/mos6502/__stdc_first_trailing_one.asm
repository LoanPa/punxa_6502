...
;	genAssignLit
	ldy	#0x00
	sty	___stdc_first_trailing_one_i_20000_164
...
;	Raw cost for generated ic 34 : (27, 36.000000) count=2.999995
;	genCall
	txa
	pha
	jsr	__slulonglong
;	assignResultValue
	...
	pla
	tax
;	Raw cost for generated ic 36 : (38, 63.000000) count=2.999995
;	genAnd
...
;	genCast
;	genCopy
	ldx	___stdc_first_trailing_one_i_20000_164
;	Raw cost for generated ic 28 : (3, 4.000000) count=2.249995
;	genPlus
;	  genPlusInc
	inx
	txa
;	Raw cost for generated ic 14 : (2, 4.000000) count=2.249995
;	genRet
	rts
