...
;	Raw cost for generated ic 95 : (14, 18.000000) count=1.000000
;	genAssign
;	genCopy
	lda	(_tancotf_PARM_1 + 3)
	sta	(___fslt_PARM_2 + 3)
...
;	genAssignLit
	ldy	#0x00
	sty	*_tancotf_sloc1_1_0
	sty	*(_tancotf_sloc1_1_0 + 1)
	sty	*(_tancotf_sloc1_1_0 + 2)
	ldx	#0x3f
...
;	genAssignLit
	...
	ldx	#0xbf
	stx	*(_tancotf_sloc1_1_0 + 3)
;	Raw cost for generated ic 18 : (12, 16.000000) count=0.250000
;	genLabel
00118$:
...
;	genAssignLit
	...
	ldx	#0x3f
	stx	(___fsmul_PARM_1 + 3)
;	Raw cost for generated ic 112 : (18, 22.000000) count=1.000000
;	genAssign
;	genCopy
	lda	*(_tancotf_sloc1_1_0 + 3)
	sta	(___fsmul_PARM_2 + 3)
...
;	Raw cost for generated ic 128 : (18, 22.000000) count=1.000000
;	genCall
	jsr	___fslt
;	assignResultValue
...
;	genAssignLit
	ldy	#0x00
	sty	_tancotf_xden_10000_26
	sty	(_tancotf_xden_10000_26 + 1)
	ldx	#0x80
	stx	(_tancotf_xden_10000_26 + 2)
	ldx	#0x3f
	stx	(_tancotf_xden_10000_26 + 3)
;	Raw cost for generated ic 43 : (18, 22.000000) count=0.750000
;	genGoto
	jmp	00105$
...
;	genAssignLit
	...
	ldx	#0x3f
	stx	(___fsadd_PARM_2 + 3)
;	Raw cost for generated ic 152 : (18, 22.000000) count=0.250000
;	genCall
	jsr	___fsadd
;	assignResultValue
