...
;	genAssignLit
	ldy	#0x00
	sty	___c16stombs_m_10000_91
	sty	(___c16stombs_m_10000_91 + 1)
...
;	genCopy
	ldy	#0x00
	sty	*(___c16stombs_sloc3_1_0 + 3)
	sty	*(___c16stombs_sloc3_1_0 + 2)
	lda	*(___c16stombs_sloc1_1_0 + 1)
...
;	  genlsh32 - shift=10
	...
	txa
	rol	a
	sty	*___c16stombs_sloc3_1_0
	asl	*(___c16stombs_sloc3_1_0 + 1)
	rol	*(___c16stombs_sloc3_1_0 + 2)
	rol	a
	sta	*(___c16stombs_sloc3_1_0 + 3)
;	Raw cost for generated ic 50 : (24, 43.000000) count=0.230759
;	genCast
;	genCopy
	sty	*(___c16stombs_sloc4_1_0 + 3)
	sty	*(___c16stombs_sloc4_1_0 + 2)
	lda	*(___c16stombs_sloc2_1_0 + 1)
	sta	*(___c16stombs_sloc4_1_0 + 1)
	lda	*___c16stombs_sloc2_1_0
	sta	*___c16stombs_sloc4_1_0
;	Raw cost for generated ic 53 : (12, 18.000000) count=0.230759
;	genPlus
...
;	Raw cost for generated ic 95 : (8, 10.000000) count=0.230759
;	genAssign
;	genCopy
...
;	Raw cost for generated ic 98 : (10, 14.000000) count=0.230759
