...
;	Raw cost for generated ic 121 : (18, 22.000000) count=1.000000
;	genCall
	jsr	___fslt
;	assignResultValue
...
;	Raw cost for generated ic 123 : (16, 20.000000) count=0.250000
;	genAssign
;	genCopy
	lda	*(_asincosf_sloc0_1_0 + 3)
...
;	genAssignLit
	...
	ldx	#0x3f
	stx	(___fslt_PARM_1 + 3)
;	Raw cost for generated ic 126 : (18, 22.000000) count=0.187500
;	genAssign
;	genCopy
	lda	*(_asincosf_sloc0_1_0 + 3)
	sta	(___fslt_PARM_2 + 3)
...
;	Raw cost for generated ic 129 : (18, 22.000000) count=0.187500
;	genAssign
;	genCopy
	lda	*(_asincosf_sloc0_1_0 + 3)
...
;	Raw cost for generated ic 166 : (14, 18.000000) count=0.750000
;	genCall
	pha
	jsr	___fslt
;	assignResultValue
...
;	genAssignLit
	...
	sty	(___fslt_PARM_2 + 2)
	sty	(___fslt_PARM_2 + 3)
;	Raw cost for generated ic 187 : (14, 18.000000) count=0.250000
;	genCall
	jsr	___fslt
;	assignResultValue
