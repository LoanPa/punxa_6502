...
00350$:
	...
	sta	*(_mbrtowc_sloc0_1_0 + 1)
00351$:
;	Raw cost for generated ic 79 : (24, 36.200001) count=2.249943
;	genCast
;	genCopy
...
;	Raw cost for generated ic 107 : (8, 11.000000) count=0.562479
;	genCmp
	sec
...
;	genAssignLit
	...
	ldy	#0x00
	sty	(_mbrtowc_PARM_3 + 1)
;	Raw cost for generated ic 153 : (10, 12.000000) count=0.562511
;	genIfx
	lda	_mbrtowc_i_10000_16
;	genIfxJump : z
	beq	00149$
...
;	genAssignLit
	...
	dey
	sty	*(_mbrtowc_sloc4_1_0 + 1)
;	Raw cost for generated ic 282 : (7, 10.000000) count=0.562527
;	genLabel
00140$:
...
;	Raw cost for generated ic 169 : (6, 8.000000) count=0.964384
;	genPointerGet
	lda	[*_mbrtowc_sloc5_1_0],y
;	Raw cost for generated ic 173 : (2, 5.000000) count=0.964384
;	genPlus
;	  genPlusInc
...
;	genCopy
	ldy	#0x00
	sty	(_mbrtowc_codepoint_10000_16 + 3)
	sty	(_mbrtowc_codepoint_10000_16 + 2)
	sty	(_mbrtowc_codepoint_10000_16 + 1)
	lda	_mbrtowc_first_byte_10000_16
	sta	_mbrtowc_codepoint_10000_16
;	Raw cost for generated ic 195 : (17, 22.000000) count=0.321475
