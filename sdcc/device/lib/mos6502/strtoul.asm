...
;	genAssignLit
	ldy	#0x00
	sty	_strtoul_ret_10000_148
	sty	(_strtoul_ret_10000_148 + 1)
	sty	(_strtoul_ret_10000_148 + 2)
	sty	(_strtoul_ret_10000_148 + 3)
;	Raw cost for generated ic 189 : (14, 18.000000) count=0.989349
;	genAssign
;	genCopy
...
;	Raw cost for generated ic 203 : (29, 38.000000) count=2.968654
;	genCast
;	genCopy
...
;	genCopy
	ldy	#0x00
	sty	*(_strtoul_sloc2_1_0 + 7)
	sty	*(_strtoul_sloc2_1_0 + 6)
	sty	*(_strtoul_sloc2_1_0 + 5)
	sty	*(_strtoul_sloc2_1_0 + 4)
	lda	*_strtoul_sloc2_1_0
;	Raw cost for generated ic 220 : (26, 38.000000) count=2.968654
;	genCmpEQorNE
...
00359$:
	lda	#0x01
00358$:
;	Raw cost for generated ic 221 : (81, 101.799995) count=2.968654
;	genNot
	eor	#0x01
...
;	genCast
	...
	sta	*(_strtoul_sloc2_1_0 + 6)
	sta	*(_strtoul_sloc2_1_0 + 7)
;	Raw cost for generated ic 228 : (25, 36.000000) count=2.968654
;	genCast
;	genCopy
	sty	*(_strtoul_sloc3_1_0 + 7)
	sty	*(_strtoul_sloc3_1_0 + 6)
	sty	*(_strtoul_sloc3_1_0 + 5)
	sty	*(_strtoul_sloc3_1_0 + 4)
	lda	(_strtoul_ret_10000_148 + 3)
	...
	lda	_strtoul_ret_10000_148
;	Raw cost for generated ic 230 : (28, 40.000000) count=2.968654
;	skipping iCode since result will be rematerialized
...
;	genCopy
	...
	sty	*(_strtoul_sloc3_1_0 + 4)
	lda	*_strtoul_sloc3_1_0
;	Raw cost for generated ic 245 : (24, 36.000000) count=2.968654
;	genCmpEQorNE
...
00370$:
	lda	#0x01
00369$:
;	Raw cost for generated ic 246 : (81, 101.799995) count=2.968654
;	genNot
	eor	#0x01
