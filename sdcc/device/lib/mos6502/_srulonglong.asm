...
;	genAssignLit
	ldy	#0x00
	sty	*__srulonglong_sloc0_1_0
;	Raw cost for generated ic 108 : (4, 5.000000) count=0.750000
;	genLabel
00110$:
...
;	genAnd
	...
	and	#0x07
	sta	*__srulonglong_sloc2_1_0
;	Raw cost for generated ic 50 : (7, 9.000000) count=0.999997
...
;	genCopy
	lda	*__srulonglong_sloc2_1_0
;	Raw cost for generated ic 54 : (2, 3.000000) count=3.999825
;	genMinus
;	  genMinusDec - size=1  icount=1
	dec	*__srulonglong_sloc2_1_0
;	Raw cost for generated ic 55 : (2, 5.000000) count=3.999825
;	genIfx
	cmp	#0x00
;	genIfxJump : z
	beq	00108$
...
;	genCopy
	ldy	#0x00
	sty	*(__srulonglong_sloc3_1_0 + 1)
	sta	*__srulonglong_sloc3_1_0
;	Raw cost for generated ic 69 : (6, 8.000000) count=0.999936
;	genPointerGet
;	  setupDPTR - off=0 remat=__srulonglong_PARM_1 savea=0
	clc
	adc	#<(__srulonglong_PARM_1+0)
	...
	sta	*(DPTR+1)
	lda	[DPTR],y
;	Raw cost for generated ic 70 : (14, 22.000000) count=0.999936
;	genAnd
	tay
	and	#0x01
...
;	genOr
	...
	ora	*(REGTEMP+0)
	tax
;	Raw cost for generated ic 81 : (5, 8.000000) count=0.999936
;	genPointerSet
;	  setupDPTR - off=0 remat=__srulonglong_PARM_1 savea=0
	clc
	...
	ldy	#0x00
	sta	[DPTR],y
;	Raw cost for generated ic 82 : (18, 28.000000) count=0.999936
...
;	genCast
;	genCopy
;	Raw cost for generated ic 89 : (0, 0.000000) count=0.999919
;	_srulonglong.c: 24: for(i=7-zb;i>=0;i--) {
;	genMinus
;	  genMinusDec - size=1  icount=1
	dec	*__srulonglong_sloc0_1_0
