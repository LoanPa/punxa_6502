...
;	genAssignLit
	ldy	#0x00
	sty	_realloc_prev_free_10000_71
	sty	(_realloc_prev_free_10000_71 + 1)
...
;	genAssignLit
	...
	ldy	#0x00
	sty	(_realloc_blocksize_10000_71 + 1)
;	Raw cost for generated ic 53 : (10, 12.000000) count=0.749999
;	genLabel
00107$:
...
;	Raw cost for generated ic 208 : (10, 14.000000) count=0.749995
;	genAssign
;	genCopy
	sta	*___memcpy_PARM_3
	stx	*(___memcpy_PARM_3 + 1)
;	Raw cost for generated ic 209 : (4, 6.000000) count=0.749995
