...
;	genAssignLit
	ldy	#0x00
	sty	__mullonglong_ret_10000_2
	sty	(__mullonglong_ret_10000_2 + 1)
	sty	(__mullonglong_ret_10000_2 + 2)
	sty	(__mullonglong_ret_10000_2 + 3)
	sty	(__mullonglong_ret_10000_2 + 4)
	sty	(__mullonglong_ret_10000_2 + 5)
	sty	(__mullonglong_ret_10000_2 + 6)
	sty	(__mullonglong_ret_10000_2 + 7)
;	Raw cost for generated ic 2 : (26, 34.000000) count=1.000000
;	../_mullonglong.c: 40: for (i = 0; i < sizeof (long long); i++)
;	genAssign
;	genAssignLit
	sty	*__mullonglong_sloc0_1_0
;	Raw cost for generated ic 61 : (2, 3.000000) count=1.000000
;	genLabel
00106$:
...
;	Raw cost for generated ic 58 : (4, 5.000000) count=3.969304
;	genLabel
00104$:
...
;	Raw cost for generated ic 13 : (6, 9.000000) count=15.846519
;	genPlus
	clc
...
;	  genlsh8 - shift=3
	...
	asl	a
	asl	a
;	Raw cost for generated ic 20 : (5, 9.000000) count=11.884890
;	genCast
;	genCopy
	sta	__srslonglong_PARM_2
...
;	Raw cost for generated ic 77 : (31, 48.000000) count=11.884890
;	genCast
;	genCopy
...
;	genCall
;	genSend
	ldx	*__mullonglong_sloc3_1_0
	lda	__mullonglong_l_30000_4
	jsr	__muluchar
;	assignResultValue
;	Raw cost for generated ic 80 : (7, 12.000000) count=11.884890
;	genCast
;	genCopy
...
;	Raw cost for generated ic 26 : (26, 34.000000) count=11.884890
;	genPlus
	lda	*__mullonglong_sloc0_1_0
	clc
...
;	assignResultValue
	...
	lda	*___SDCC_m6502_ret7
	sta	*(__mullonglong_sloc3_1_0 + 7)
;	Raw cost for generated ic 84 : (31, 48.000000) count=11.884890
;	genPlus
...
;	Raw cost for generated ic 36 : (2, 5.000000) count=11.884890
;	genGoto
	jmp	00104$
