...
;	genCast
	...
	dey
	sty	*(_asctime_sloc2_1_0 + 1)
;	Raw cost for generated ic 16 : (5, 8.000000) count=1.000000
;	genAssign
;	genCopy
	ldx	(_asctime_timeptr_10000_35 + 1)
	lda	_asctime_timeptr_10000_35
...
;	  setupDPTR - off=2 remat=(null) savea=0
	...
	ldy	#0x02
	lda	[DPTR],y
;	Raw cost for generated ic 19 : (8, 13.000000) count=1.000000
;	genCast
	sta	*_asctime_sloc3_1_0
	ldy	#0x00
	sty	*(_asctime_sloc3_1_0 + 1)
...
;	  setupDPTR - off=3 remat=(null) savea=0
	...
	ldy	#0x03
	lda	[DPTR],y
;	Raw cost for generated ic 23 : (8, 13.000000) count=1.000000
;	genCast
	sta	*_asctime_sloc4_1_0
	ldy	#0x00
	sty	*(_asctime_sloc4_1_0 + 1)
...
;	  setupDPTR - off=4 remat=(null) savea=0
	...
	ldy	#0x04
	lda	[DPTR],y
;	Raw cost for generated ic 28 : (8, 13.000000) count=1.000000
;	genCast
;	genCopy
	ldx	#0x00
...
;	genAssignLit
	...
	ldy	#0x00
	sty	(__modulong_PARM_2 + 1)
	sty	(__modulong_PARM_2 + 2)
	sty	(__modulong_PARM_2 + 3)
;	Raw cost for generated ic 158 : (16, 20.000000) count=1.000000
;	genCall
	jsr	__modulong
;	assignResultValue
...
;	genAssignLit
	...
	ldy	#0x00
	sty	(__divulong_PARM_2 + 1)
	sty	(__divulong_PARM_2 + 2)
	sty	(__divulong_PARM_2 + 3)
;	Raw cost for generated ic 161 : (16, 20.000000) count=1.000000
...
;	genAssignLit
	...
	sty	(__modulong_PARM_2 + 2)
	sty	(__modulong_PARM_2 + 3)
;	Raw cost for generated ic 164 : (16, 20.000000) count=1.000000
;	genCall
	jsr	__modulong
;	assignResultValue
	sta	*_gmtime_sloc0_1_0
...
;	genAssignLit
	...
	sty	(__divulong_PARM_2 + 2)
	sty	(__divulong_PARM_2 + 3)
;	Raw cost for generated ic 167 : (16, 20.000000) count=1.000000
...
;	genAssignLit
	...
	sty	(__modulong_PARM_2 + 2)
	sty	(__modulong_PARM_2 + 3)
;	Raw cost for generated ic 170 : (16, 20.000000) count=1.000000
;	genCall
	jsr	__modulong
;	assignResultValue
	sta	*_gmtime_sloc0_1_0
...
;	genAssignLit
	...
	sty	(__divulong_PARM_2 + 2)
	sty	(__divulong_PARM_2 + 3)
;	Raw cost for generated ic 173 : (16, 20.000000) count=1.000000
...
;	Raw cost for generated ic 178 : (10, 12.000000) count=1.000000
...
;	genAssignLit
	ldy	#0x00
	sty	_gmtime_days_10000_42
	sty	(_gmtime_days_10000_42 + 1)
	sty	(_gmtime_days_10000_42 + 2)
	sty	(_gmtime_days_10000_42 + 3)
;	Raw cost for generated ic 34 : (14, 18.000000) count=1.000000
...
;	Raw cost for generated ic 60 : (10, 13.000000) count=0.999995
;	genIfx
	lda	*(_gmtime_sloc2_1_0 + 1)
...
;	  setupDPTR - off=0 remat=_monthDays savea=0
	...
	sta	*(DPTR+1)
	lda	[DPTR],y
;	Raw cost for generated ic 99 : (14, 22.000000) count=0.571421
;	genLabel
00109$:
...
;	Raw cost for generated ic 102 : (10, 14.000000) count=2.285686
;	genCmp
...
;	Raw cost for generated ic 124 : (10, 12.000000) count=2.999995
...
;	genAssignLit
	...
	ldy	#0x00
	sty	(__modsint_PARM_2 + 1)
;	Raw cost for generated ic 127 : (10, 12.000000) count=0.999997
...
;	genAssignLit
	ldy	#0x00
	sty	*_mktime_sloc0_1_0
	sty	*(_mktime_sloc0_1_0 + 1)
...
;	genAssignLit
	...
	ldy	#0x00
	sty	(__mullong_PARM_1 + 3)
;	Raw cost for generated ic 132 : (20, 24.000000) count=0.999990
;	genCall
	jsr	__mullong
;	assignResultValue
	sta	*_mktime_sloc2_1_0
...
;	genCast
	...
	sty	(__mullong_PARM_2 + 2)
	sty	(__mullong_PARM_2 + 3)
;	Raw cost for generated ic 82 : (14, 18.000000) count=0.999990
;	genAssign
;	genAssignLit
	ldx	#0x10
	stx	__mullong_PARM_1
...
;	genCast
	sta	__mulint_PARM_2
	dey
	sty	(__mulint_PARM_2 + 1)
;	Raw cost for generated ic 89 : (7, 10.000000) count=0.999990
