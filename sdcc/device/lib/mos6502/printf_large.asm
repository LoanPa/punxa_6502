...
;	genSend
	...
	sta	*(REGTEMP+0)
	pla
;	Raw cost for generated ic 5 : (15, 29.000000) count=1.000000
...
;	assignResultValue
	...
	pla
;	Raw cost for generated ic 748 : (21, 35.000000) count=0.308379
;	genCast
;	genCopy
;	Raw cost for generated ic 60 : (1, 2.000000) count=0.308379
;	genCast
;	genCopy
	ldx	#0x00
;	Raw cost for generated ic 61 : (2, 2.000000) count=0.308379
;	genPlus
	clc
...
;	assignResultValue
	...
	stx	*(__print_format_sloc1_1_0 + 1)
	pla
;	Raw cost for generated ic 751 : (21, 35.000000) count=0.106922
;	genCast
;	genCopy
	ldx	#0x00
;	Raw cost for generated ic 73 : (3, 4.000000) count=0.106922
;	genPlus
	clc
	adc	*__print_format_sloc1_1_0
	pha
...
;	genAssignLit
	ldy	#0x00
	sty	__print_format_decimals_10000_233
	sty	(__print_format_decimals_10000_233 + 1)
;	Raw cost for generated ic 88 : (8, 10.000000) count=0.061003
...
;	genAssignLit
	ldy	#0x00
	sty	_lower_case
;	Raw cost for generated ic 110 : (5, 6.000000) count=0.025599
;	genLabel
00118$:
...
;	genCopy
	...
	lda	__print_format_width_10000_233
	sta	*__print_format_sloc0_1_0
;	Raw cost for generated ic 685 : (7, 10.000000) count=0.000000
;	genLabel
00136$:
...
;	genMinus
;	  genMinusDec - size=2  icount=1
	ldy	*__print_format_sloc0_1_0
	bne	00832$
	dec	*(__print_format_sloc0_1_0 + 1)
00832$:
	dec	*__print_format_sloc0_1_0
;	Raw cost for generated ic 223 : (8, 15.600000) count=0.000000
;	genIfx
	cmp	#0x00
;	genIfxJump : z
	bne	00834$
	...
	beq	00312$
00834$:
;	Raw cost for generated ic 225 : (11, 12.200000) count=0.000000
...
;	genSend
	lda	#0x20
	jsr	__output_char
;	Raw cost for generated ic 229 : (5, 8.000000) count=0.000000
;	genGoto
	jmp	00136$
...
;	genCopy
	...
	lda	*__print_format_sloc0_1_0
	sta	__print_format_width_10000_233
;	Raw cost for generated ic 687 : (10, 14.000000) count=0.000000
;	genLabel
00277$:
...
;	genCopy
	...
	lda	__print_format_width_10000_233
	sta	*__print_format_sloc1_1_0
;	Raw cost for generated ic 691 : (7, 10.000000) count=0.000000
;	genLabel
00146$:
...
;	genMinus
;	  genMinusDec - size=2  icount=1
	ldy	*__print_format_sloc1_1_0
	bne	00845$
	dec	*(__print_format_sloc1_1_0 + 1)
00845$:
	dec	*__print_format_sloc1_1_0
;	Raw cost for generated ic 270 : (8, 15.600000) count=0.000000
;	genIfx
	cmp	#0x00
;	genIfxJump : z
	bne	00847$
	...
	jmp	00314$
00847$:
;	Raw cost for generated ic 272 : (11, 12.200000) count=0.000000
...
;	genSend
	lda	#0x20
	jsr	__output_char
;	Raw cost for generated ic 276 : (5, 8.000000) count=0.000000
;	genGoto
	jmp	00146$
...
;	genCopy
	...
	lda	*__print_format_sloc1_1_0
	sta	__print_format_width_10000_233
;	Raw cost for generated ic 694 : (10, 14.000000) count=0.000000
;	genLabel
00160$:
...
;	genAssignLit
	ldy	#0x00
	sty	__print_format_signed_argument_10000_233
;	Raw cost for generated ic 448 : (5, 6.000000) count=0.000000
;	genLabel
00178$:
...
;	genAssignLit
	...
	sty	*(__print_format_sloc1_1_0 + 1)
...
;	genDataPointerSet
	ldy	#0x00
	sty	(_value + 0x0004)
;	Raw cost for generated ic 457 : (5, 6.000000) count=0.000000
...
;	genAssignLit
	...
	ldy	#0x00
	sty	(__print_format_width_10000_233 + 1)
;	Raw cost for generated ic 506 : (10, 12.000000) count=0.000000
;	genLabel
00186$:
...
;	genCast
;	genCopy
	ldx	__print_format_length_10000_233
...
;	  genPlusInc
	inx
	txa
;	Raw cost for generated ic 517 : (2, 4.000000) count=0.000000
;	genCast
;	genCopy
...
;	genSend
	...
	tax
	pla
;	Raw cost for generated ic 586 : (14, 32.000000) count=0.000000
;	genGoto
	jmp	00203$
...
;	genAssignLit
	...
	sty	__print_format_width_10000_233
	sty	(__print_format_width_10000_233 + 1)
;	Raw cost for generated ic 599 : (8, 10.000000) count=0.000000
;	../printf_large.c: 877: return charsOutputted;
;	genGoto
	jmp	00309$
