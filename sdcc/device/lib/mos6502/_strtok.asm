...
;	genCopy
	sta	*_strchr_PARM_2
;	Raw cost for generated ic 23 : (2, 3.000000) count=1.714284
...
;	genCopy
	sta	*_strchr_PARM_2
;	Raw cost for generated ic 48 : (2, 3.000000) count=2.999988
...
;	  setupDPTR - off=0 remat=(null) savea=0
	...
	stx	*(DPTR+1)
	lda	[DPTR],y
;	Raw cost for generated ic 70 : (12, 19.000000) count=0.999993
;	genIfx
;	genIfxJump : z
	beq	00117$
