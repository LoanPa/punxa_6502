...
;	genAssignLit
	ldy	#0x00
	sty	_mbstowcs_m_10000_43
	sty	(_mbstowcs_m_10000_43 + 1)
;	Raw cost for generated ic 3 : (8, 10.000000) count=1.000000
;	../mbstowcs.c: 36: while(n--)
;	genAssign
;	genAssignLit
	sty	*_mbstowcs_sloc1_1_0
	sty	*(_mbstowcs_sloc1_1_0 + 1)
...
;	Raw cost for generated ic 16 : (10, 12.000000) count=1.714280
