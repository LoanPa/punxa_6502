...
;	genAssignLit
	ldy	#0x00
	sty	_atanf_n_10000_26
	sty	(_atanf_n_10000_26 + 1)
...
;	Raw cost for generated ic 72 : (18, 22.000000) count=1.000000
;	genAssign
;	genCopy
...
;	Raw cost for generated ic 75 : (18, 22.000000) count=0.750000
;	genAssign
;	genCopy
	lda	*(_atanf_sloc0_1_0 + 3)
...
;	Raw cost for generated ic 85 : (18, 22.000000) count=0.750000
;	genCall
	jsr	___fssub
;	assignResultValue
	sta	___fsadd_PARM_1
...
;	Raw cost for generated ic 97 : (18, 22.000000) count=1.000000
;	genCall
	jsr	___fslt
;	assignResultValue
...
;	Raw cost for generated ic 127 : (14, 18.000000) count=1.000000
;	genCall
	jsr	___fslt
;	assignResultValue
