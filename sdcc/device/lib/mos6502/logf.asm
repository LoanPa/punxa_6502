...
;	Raw cost for generated ic 55 : (14, 18.000000) count=1.000000
;	genAssign
;	genCopy
	lda	(_logf_PARM_1 + 3)
...
;	Raw cost for generated ic 59 : (16, 20.000000) count=1.000000
;	genCall
	jsr	___fssub
;	assignResultValue
	sta	*_logf_sloc1_1_0
...
;	genAssignLit
	...
	ldx	#0x3f
	stx	(___fssub_PARM_2 + 3)
;	Raw cost for generated ic 65 : (16, 20.000000) count=0.750000
;	genCall
	jsr	___fssub
;	assignResultValue
	sta	_logf_znum_10000_26
...
;	genAssignLit
	...
	sty	(___fsmul_PARM_1 + 2)
	ldx	#0x3f
	stx	(___fsmul_PARM_1 + 3)
;	Raw cost for generated ic 67 : (16, 20.000000) count=0.750000
;	genAssign
;	genCopy
	lda	*(_logf_sloc0_1_0 + 3)
...
;	Raw cost for generated ic 71 : (16, 20.000000) count=0.750000
;	genCall
	jsr	___fsadd
;	assignResultValue
...
;	genAssignLit
	...
	ldx	#0x3f
	stx	(___fsmul_PARM_1 + 3)
;	Raw cost for generated ic 73 : (16, 20.000000) count=0.250000
;	genAssign
;	genCopy
	lda	*(_logf_sloc1_1_0 + 3)
	sta	(___fsmul_PARM_2 + 3)
...
;	genAssignLit
	...
	ldx	#0x3f
	stx	(___fsadd_PARM_2 + 3)
;	Raw cost for generated ic 77 : (16, 20.000000) count=0.250000
;	genCall
	jsr	___fsadd
;	assignResultValue
	sta	_logf_zden_10000_26
...
;	genAssignLit
	...
	ldx	#0x3f
	stx	(___fsmul_PARM_1 + 3)
;	Raw cost for generated ic 108 : (20, 24.000000) count=1.000000
;	genAssign
;	genCopy
	lda	*(_logf_sloc1_1_0 + 3)
	sta	(___fsmul_PARM_2 + 3)
