...
;sloc1         Allocated with name '___stdc_count_ones_sloc1_1_0'
...
;	genAssignLit
	ldy	#0x00
	sty	*___stdc_count_ones_sloc0_1_0
;	Raw cost for generated ic 29 : (4, 5.000000) count=1.000000
;	genAssign
;	genCopy
	ldx	#0x00
...
;	Raw cost for generated ic 38 : (27, 36.000000) count=2.999995
;	genCall
	txa
	pha
	jsr	__slulonglong
;	assignResultValue
	sta	*___stdc_count_ones_sloc1_1_0
	stx	*(___stdc_count_ones_sloc1_1_0 + 1)
	lda	*___SDCC_m6502_ret2
	sta	*(___stdc_count_ones_sloc1_1_0 + 2)
	lda	*___SDCC_m6502_ret3
	sta	*(___stdc_count_ones_sloc1_1_0 + 3)
	lda	*___SDCC_m6502_ret4
	sta	*(___stdc_count_ones_sloc1_1_0 + 4)
	lda	*___SDCC_m6502_ret5
	sta	*(___stdc_count_ones_sloc1_1_0 + 5)
	lda	*___SDCC_m6502_ret6
	sta	*(___stdc_count_ones_sloc1_1_0 + 6)
	lda	*___SDCC_m6502_ret7
	sta	*(___stdc_count_ones_sloc1_1_0 + 7)
	pla
	tax
;	Raw cost for generated ic 40 : (38, 63.000000) count=2.999995
;	genAnd
	lda	___stdc_count_ones_PARM_1
	and	*___stdc_count_ones_sloc1_1_0
	bne	00129$
	lda	(___stdc_count_ones_PARM_1 + 1)
	and	*(___stdc_count_ones_sloc1_1_0 + 1)
	bne	00129$
	lda	(___stdc_count_ones_PARM_1 + 2)
	and	*(___stdc_count_ones_sloc1_1_0 + 2)
	bne	00129$
	lda	(___stdc_count_ones_PARM_1 + 3)
	and	*(___stdc_count_ones_sloc1_1_0 + 3)
	bne	00129$
	lda	(___stdc_count_ones_PARM_1 + 4)
	and	*(___stdc_count_ones_sloc1_1_0 + 4)
	bne	00129$
	lda	(___stdc_count_ones_PARM_1 + 5)
	and	*(___stdc_count_ones_sloc1_1_0 + 5)
	bne	00129$
	lda	(___stdc_count_ones_PARM_1 + 6)
	and	*(___stdc_count_ones_sloc1_1_0 + 6)
	bne	00129$
	lda	(___stdc_count_ones_PARM_1 + 7)
	and	*(___stdc_count_ones_sloc1_1_0 + 7)
00129$:
;	genIfxJump : z
	beq	00106$
...
;	genPlus
;	  genPlusInc
	inc	*___stdc_count_ones_sloc0_1_0
;	Raw cost for generated ic 15 : (2, 5.000000) count=2.249995
;	genLabel
00106$:
...
;	genCast
;	genCopy
	lda	*___stdc_count_ones_sloc0_1_0
;	Raw cost for generated ic 24 : (2, 3.000000) count=0.999997
;	genRet
