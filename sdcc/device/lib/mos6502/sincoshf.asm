...
;	Raw cost for generated ic 92 : (14, 18.000000) count=1.000000
;	genCall
	jsr	___fslt
;	assignResultValue
...
;	Raw cost for generated ic 94 : (18, 22.000000) count=1.000000
;	genAssign
;	genCopy
...
;	genAssignLit
	...
	ldx	#0x41
	stx	(___fslt_PARM_1 + 3)
;	Raw cost for generated ic 97 : (18, 22.000000) count=0.812500
;	genAssign
;	genCopy
	lda	(_sincoshf_y_10000_26 + 3)
	sta	(___fslt_PARM_2 + 3)
...
;	Raw cost for generated ic 101 : (20, 24.000000) count=0.609375
...
;	Raw cost for generated ic 112 : (18, 22.000000) count=0.203125
;	genAssign
;	genCopy
...
;	genAssignLit
	...
	ldx	#0x3f
	stx	(___fsmul_PARM_1 + 3)
;	Raw cost for generated ic 118 : (16, 20.000000) count=0.203125
;	genCall
	jsr	___fsmul
;	assignResultValue
	sta	_sincoshf_z_10000_26
...
;	Raw cost for generated ic 122 : (18, 22.000000) count=0.187500
;	genCall
	jsr	___fslt
;	assignResultValue
