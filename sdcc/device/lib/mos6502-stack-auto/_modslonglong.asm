...
;------------------------------------------------------------
;numerator     Allocated to stack - sp +19 +8 
;denominator   Allocated to stack - sp +27 +8 
;numeratorneg  Allocated to registers y 
;denominatorneg Allocated to registers a 
;r             Allocated to stack - sp +7 +8 
...
00131$:
	lda	#0x01
00132$:
;	Raw cost for generated ic 4 : (21, 25.400002) count=1.000000
...
;	genUminus
	...
	sta	0x11a,x
	pla
;	Raw cost for generated ic 9 : (67, 97.000000) count=0.750000
;	genLabel
00102$:
...
;	genUminus
	...
	sbc	0x122,x
	sta	0x122,x
;	Raw cost for generated ic 15 : (66, 92.000000) count=0.750000
;	genLabel
00104$:
...
;	genIpush
	...
	lda	0x101,x
	pha
;	Raw cost for generated ic 32 : (34, 61.000000) count=1.000000
;	genIpush
	lda	0x110,x
	pha
	lda	0x10f,x
	...
	lda	0x109,x
	pha
;	Raw cost for generated ic 33 : (32, 56.000000) count=1.000000
...
;	  adjustStack : cycles stk:64  incdec:34  adc:10
	...
	tay
	lda	*(REGTEMP+0)
;	Raw cost for generated ic 34 : (56, 94.000000) count=1.000000
;	genIfx
	cpy	#0x00
;	genIfxJump : z
	beq	00107$
;	Raw cost for generated ic 22 : (7, 7.600000) count=1.000000
;	genUminus
	lda	#0x00
	sec
	sbc	0x102,x
	...
	sbc	0x109,x
	sta	0x111,x
;	Raw cost for generated ic 23 : (65, 90.000000) count=0.750000
;	genGoto
	jmp	00108$
...
;	genCopy
	...
	lda	0x101,x
	sta	0x109,x
;	Raw cost for generated ic 27 : (49, 74.000000) count=0.250000
;	genLabel
00108$:
...
;	genRet
	...
	sta	*(REGTEMP+0)
	lda	0x109,x
;	Raw cost for generated ic 29 : (41, 58.000000) count=1.000000
;	genLabel
...
;	  adjustStack : cycles stk:70  incdec:42  adc:24
	...
	ldx	*(REGTEMP+0)
	rts
;	Raw cost for generated ic 31 : (16, 30.000000) count=1.000000
	.area CODE
	.area RODATA
	.area XINIT
	.area CABS    (ABS)
