...
;	genCopy
	tay
;	Raw cost for generated ic 33 : (1, 2.000000) count=1.000000
;	genLabel
00105$:
...
;	genCopy
	tya
;	Raw cost for generated ic 37 : (1, 2.000000) count=2.999697
;	genIpush
	sta	*(REGTEMP+0)
	tya
	pha
	lda	*(REGTEMP+0)
	pha
;	Raw cost for generated ic 38 : (7, 14.000000) count=2.999697
;	genIpush
	lda	#0x00
	pha
	pha
	...
	lda	#0x01
	pha
;	Raw cost for generated ic 39 : (12, 28.000000) count=2.999697
;	genCall
	jsr	__slulonglong
;	assignResultValue
	stx	*(REGTEMP+0)
...
;	  adjustStack : cycles stk:36  incdec:20  adc:10
	...
	pla
	tay
;	Raw cost for generated ic 40 : (56, 94.000000) count=2.999697
;	genAnd
	lda	0x10d,x
	and	0x102,x
	bne	00130$
...
;	  genMinusDec - size=1  icount=1
	dey
;	Raw cost for generated ic 23 : (1, 2.000000) count=2.999596
;	genAssign
;	genCopy
	tya
	tsx
	sta	0x109,x
;	Raw cost for generated ic 24 : (5, 9.000000) count=2.999596
;	genGoto
	jmp	00105$
...
;	  adjustStack : cycles stk:42  incdec:28  adc:24
	...
	ldx	*(REGTEMP+0)
	rts
;	Raw cost for generated ic 29 : (16, 30.000000) count=0.999821
	.area CODE
	.area RODATA
	.area XINIT
	.area CABS    (ABS)
