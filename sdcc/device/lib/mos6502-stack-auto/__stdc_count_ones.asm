...
;	genAssignLit
	lda	#0x00
	sta	0x109,x
;	Raw cost for generated ic 29 : (5, 7.000000) count=1.000000
;	genAssign
;	genCopy
	tay
;	Raw cost for generated ic 32 : (1, 2.000000) count=1.000000
;	genLabel
00105$:
...
;	genCopy
	tya
;	Raw cost for generated ic 37 : (1, 2.000000) count=2.999995
;	genIpush
	sta	*(REGTEMP+0)
	tya
	pha
	lda	*(REGTEMP+0)
	pha
;	Raw cost for generated ic 38 : (7, 14.000000) count=2.999995
;	genIpush
	lda	#0x00
	pha
	pha
	...
	lda	#0x01
	pha
;	Raw cost for generated ic 39 : (12, 28.000000) count=2.999995
;	genCall
	jsr	__slulonglong
;	assignResultValue
	stx	*(REGTEMP+0)
...
;	  adjustStack : cycles stk:36  incdec:20  adc:10
	...
	pla
	tay
;	Raw cost for generated ic 40 : (56, 94.000000) count=2.999995
;	genAnd
	lda	0x10d,x
	and	0x102,x
	bne	00129$
...
;	  genPlusInc
	...
	adc	#0x01
	sta	0x10a,x
;	Raw cost for generated ic 15 : (9, 13.000000) count=2.249995
;	genLabel
00106$:
