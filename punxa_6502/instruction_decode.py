...
ADDRESSING_IMPLIED = 'IMP'
ADDRESSING_IMMEDIATE = 'IMM'
ADDRESSING_ABSOLUTE = 'ABS'
ADDRESSING_ABSOLUTEX = 'ABSX'
ADDRESSING_ABSOLUTEY = 'ABSY'
ADDRESSING_INDIRECT = 'IND'
ADDRESSING_INDIRECTX = 'INDX'
ADDRESSING_INDIRECTY = 'INDY'
ADDRESSING_ZEROPAGE = 'Z'
ADDRESSING_ZEROPAGEX = 'ZX'
ADDRESSING_ZEROPAGEY = 'ZY'
ADDRESSING_ACCUMULATOR = 'A'
ADDRESSING_RELATIVE = 'R'
ADDRESSING_NONE = '-'
