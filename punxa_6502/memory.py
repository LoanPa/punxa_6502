# -*- coding: utf-8 -*-
"""
Created on Wed May 28 16:48:12 2025
...
class MemoryInterface(py4hw.Interface):
    ...
    def __init__(self, parent:py4hw.Logic, name:str, data_width:int, address_width:int):
...
class SparseMemory(py4hw.Logic):
    def __init__(self, parent:py4hw.Logic, name:str, data_width:int, address_width:int, port:MemoryInterface, endianness='little', mem_base=0):
        super().__init__(parent, name)
